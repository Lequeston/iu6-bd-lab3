              ...
              <Row gutter={[16, 0]}>
                ...
                <Col flex="auto">
                  <Row>
                    <Col>
                      <Row>
                        <Col>Время вылета: </Col>
                        <Col>{dayjs(item.airDepartureData).format('HH:mm')}</Col>
                      </Row>
                      <Row>
                        <Col>Аэропорт: </Col>
                        <Col>{item.route.airDeparture.title}</Col>
                      </Row>
                      <Row>
                        <Col>Город: </Col>
                        <Col>{item.route.airDeparture.city}</Col>
                      </Row>
                    </Col>
                    <Col>
                      <Row></Row>
                    ...
                    <Col>
                      <Row>
                        <Col>Время прилёта: </Col>
                        <Col>{dayjs(item.airArrivalData).format('HH:mm')}</Col>
                      </Row>
                      <Row>
                        <Col>Аэропорт:</Col>
                        <Col>{item.route.airArrival.title}</Col>
                      </Row>
                      <Row>
                        <Col>Город:</Col>
                        <Col>{item.route.airArrival.city}</Col>
                      </Row>
                    </Col>
                  </Row>
                  <Row>
